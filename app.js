...
async function renderVectorPdf(data,scale){
  ...
  if(!drawWrapped(data.meta,{size:8.5*scale,color:muted,after:5*scale}))return {overflow:true};
  ...
  y-=6*scale;if(!heading('Soovitused ja kommentaarid',10.5*scale))return {overflow:true};
